...
public class MessageBoardModel{
    ...
    */
    public static LinkedList<Post> searchPosts( String user, LocalDateTime startDate, LocalDateTime endDate, LinkedList<String> hashtag) throws IOException {

        LinkedList<Post> posts = postDAO.getAllPosts();

        BusinessLayer businessLayer = new BusinessLayer();
        return businessLayer.searchPosts(posts, user, startDate, endDate, hashtag);
